...
L["Ravenous Anima Cell"] = "贪婪的心能单元"
L["Plundered Anima Cell"] = "掠夺的心能单元"
L["Requisitioned Anima Cell"] = "征用的心能单元"
L["Obscuring Essence Potion"] = "复苏的虹吸精华"
L["Phantasmic Infuser"] = "虚幻灌注者"

L["Click to use %s"] = "点击使用 %s"
L["Anima Cell"] = "心能单元"
L["Dropped Anima Cell"] = "掉落的心能单元"
L["Ravenous Anima Cell"] = "贪婪的心能单元"
L["%s Count"] = "%s 计数"
L["%s - \n%s:\n%s"] = "%s - \n%s:\n%s"
L["%s - %s%s"] = "%s - %s%s"
...
L["Ravenous Anima Cell Powers"] = "贪婪的心能单元"
L["Torghast Mobs"] = "托加斯特怪物"

--Options
L["General Options"] = "常规选项"
L["Tooltip Options"] = "鼠标提示选项"
L["Show Rare Ability Drop Tooltips"] = "显示稀有心能单元掉落"
L["Show Ravenous Anima Cell Tooltips"] = "显示贪婪的心能单元掉落"
L["Settings"] = "设置"
L["Options"] = "选项"
L["Always"] = "总是"
L["Reset Stats"] = "重置统计"
...
L["CURRENT RUN:"] = "当前运行:"
L["Total "] = "全部 "
L["%sDeaths: %s"] = "%s 死亡人数: %s"
L["%sFloors Climbed: %s"] = "%s 已爬层数: %s"
L["%sAnima Powers Collected: %s"] = "%s 收集到的心能: %s"
L["%sPhantasma Collected: %s"] = "%s 收集到的灵魂残疾: %s"
L["%sAshen Phylactery Broken: %s"] = "%s 摧毁灰烬护命匣: %s"
L["%sMobs Killed: %s"] = "%s 击杀怪物: %s"
L["%sMawrats Killed: %s"] = "%s 击杀噬渊鼠: %s"
L["%sTimes Tarragrue Released: %s"] = "%s 塔拉格鲁出现时间: %s"
L["%sTime Spent: %s"] = "%s 已用时间: %s"
L["%sTraps Sprung: %s"] = "%s 陷阱: %s"
L["Bosses: %s - Rares: %s - Mawrats: %s"] = "首领: %s - 稀有: %s - 噬渊鼠: %s"
L["%sSouls Collected: %s"] = "%s 已收集灵魂: %s"
L["%sChests Opened: %s"] = "%s 打开箱子: %s"
L["%sQuests Completed: %s"] = "%s 任务已完成: %s"
L["%sSuccessful Runs: %s"] = "%s 成功通过: %s"
...
L["Failed Bouns: %s"] = "失去分数的项目: %s"
L["Gained Bouns: %s"] = "获得分数的项目: %s"
L["Bonuses: %s"] = "奖励: %s"
L["Score:"] = "分数:"
L["Completion: %s"] = "完成: %s"
L["Pauper  +10pts"] = "赤贫者 +10pts"
L["Highlander + 15pts"] = "高地人 +15pts"
...
L["Corrus_Tip1"] = "如果您可以从任何供应商处获得盲目烟尘胶囊,则可以使用它们来完全避免<暗影割裂>。 如果没有,您可以打断<暗夜割裂>,但这不应该是您的首要任务。<暗影割裂>的 DOT 非常弱。"
...
L["Thonar_Tip1"] = "盲目烟尘胶囊对管理者索纳尔非常强大,因为他的近战伤害非常高。 如果您看到任何供应商出售这些产品,请购买它们！"
...
L["Soulmass_Tip2"] = "您可以使用减速和控制技能来阻止较小的小怪在您身上爆炸。盲目烟尘胶囊也可以很好地避免大规模爆炸伤害。"
...
--Torments
L["Avenger_Tip"] = "这会导致怪物在死亡时对附近的任何盟友施加复仇者。其他的怪物可以获得增益,但不会在它们死后将其应用于其他人。微不足道的敌人的例子有：噬渊鼠、渊誓卫徒和骷髅残骸。\n\n复仇将提供 10% 的急速和攻击速度,最多叠加 10 次。只要敌人仍在战斗中,它们就会保留这些增益,因此如果它们重置或您可以以任何方式放弃战斗,它将移除所有增益。您可以通过远离托加斯特的重生点或使用各种职业/种族特定技能（例如消失、假死和影遁）来故意迫使敌人重置战斗。"
...
L["Annihilator_Desc"] = "20秒内消灭首领"
L["Collector_Desc"] = "至少收集30种噬渊之力(心能之力)"
L["Daredevil_Desc"] = "10秒内击杀两名精英敌人"
L["Executioner_Desc"] = "40秒内击杀首领"
L["Highlander_Desc"] = "没有重复的心能之力"
L["Hoarder_Desc"] = "队伍完成本次挑战时剩余 %s 幻灭心能"
--(Note: Phantasma required will scale up per member of your party!)	10
L["Hunter_Desc"] = "没有敌人获得4层的非自然之力"
L["Pauper_Desc"] = "没有史诗品质的心能之力"
L["Pillager_Desc"] = "摧毁 90% 的灰烬护命匣"
L["Plunderer_Desc"] = "打开宝箱"
L["Reinforced_Desc"] = "收集5层某种奥伯勒隆之力"
L["Rescuer_Desc"] = "协助托加斯特的一位住民"
L["Robber_Desc"] = "抢劫一名掮灵(需要商店扒手祝福和贪婪的心能单元)"
L["Savior_Desc"] = "解放所有灵魂" 
L["Trapmaster_Desc"] = "没有受到陷阱伤害"
L["Empowered"] = "强壮状态下的行为可以获得额外分数"
